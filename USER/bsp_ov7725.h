...
//#define OV7725_VSYNC  	  PEin(5)			//同步信号检测IO       E5
//#define OV7725_WRST		  PCout(4)		//写指针复位               C4
//#define OV7725_WREN		  PDout(3)		//写入FIFO使能             D3
//#define OV7725_RCK_H	  GPIOC->BSRR=1<<5//设置读数据时钟高电平   C5
//#define OV7725_RCK_L	  GPIOC->BRR=1<<5	//设置读数据时钟低电平   
//#define OV7725_RRST		  PAout(2)  		//读指针复位           A2
//#define OV7725_CS		  PAout(3)  		//片选信号(OE)         A3
//
//#define OV7725_DATA       GPIOC->IDR&0xFF00  	//数据输入端口     C8-15
/////////////////////////////////////////

/************************** OV7725 连接引脚定义********************************/
// FIFO 输出使能，即模块中的OE           A3
#define      OV7725_OE_GPIO_CLK                       RCC_APB2Periph_GPIOA
#define      OV7725_OE_GPIO_PORT                      GPIOA
#define      OV7725_OE_GPIO_PIN                       GPIO_Pin_3
#define  	 OV7725_CS                                PAout(3)  
...
// FIFO 读时钟                            A1
#define      OV7725_RCLK_GPIO_CLK                     RCC_APB2Periph_GPIOA
#define      OV7725_RCLK_GPIO_PORT                    GPIOA
#define      OV7725_RCLK_GPIO_PIN                     GPIO_Pin_1

#define      OV7725_RCK_H	                        GPIOA->BSRR=1<<1//设置读数据时钟高电平
#define      OV7725_RCK_L	                        GPIOA->BRR=1<<1	//设置读数据时钟低电平
...
#define      OV7725_DATA                              GPIOD->IDR&0x00FF
// 8位数据口 ,, GPIO: D0-7
#define      OV7725_DATA_GPIO_CLK                     RCC_APB2Periph_GPIOD
